...
answers.createValidator = function createValidator() {
...
answers.isNotEmpty = function isNotEmpty(value) {
  return Boolean(value);
};

answers.isNumeric = function isNumeric(value) {
  return /^(\d+\.)?\d+$/.test(value);
};

answers.isTimeEntry = function isTimeEntry(value) {
