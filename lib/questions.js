...
questions.githubAccessTokenHelp = function(opts) {
  return Object.assign({
    ...
    message: `First off, you need a GitHub account. We recommend creating a new account specifically for gitevents.
After that is sorted you need to create an API access token. You can create one on https://github.com/settings/tokens/new.
